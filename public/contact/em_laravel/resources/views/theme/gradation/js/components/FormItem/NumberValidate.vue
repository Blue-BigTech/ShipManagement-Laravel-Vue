<template>
  <div>
    ...
    >
      ...
      <div v-if="failedRules.required && failedRules.numeric" class="validateError">{{ form_item.required_error_msg }}</div>
      <div v-else-if="failedRules.required" class="validateError">{{ form_item.required_error_msg }}</div>
      <div v-else-if="failedRules.numeric" class="validateError">{{ form_item.restriction_error_msg }}</div>
    </ValidationProvider>
    <ValidationProvider
    ...
    >
      <input
        ...
        :name="form_item.name"
        class="form__input"
        :class="{invalid: invalid ,confirmMode:confirmMode}"
        :placeholder="form_item.placeholder"
        v-model="numberValue"
      />
      <span
      ...
      <div v-if="failedRules.numeric" class="validateError">{{ form_item.required_error_msg }}</div>
    </ValidationProvider>
  </div>
</template>
