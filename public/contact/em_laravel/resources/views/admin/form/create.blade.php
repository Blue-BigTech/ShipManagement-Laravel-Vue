...
@section('title', __("admin_messages.page_title_form_create") ." | ". __("admin_messages.page_title"))
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12 mt-3 mb-1">
        <h3 class="page-header">{{__("admin_messages.menu.form_regist")}}</h3>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-12">
        @isset($append['admin_from_create_upper_form']){!! $append['admin_from_create_upper_form'] !!}@endisset
        <form action="{{ route("admin.form.create") }}" method="post" id="main_form">
