  ...
  $ ( document ).ready ( function() {
    ...
    function add_select_choice_wrap () {
      let html = "<div class=\"row form-inline mb-1\">\n" +
        "<input type=\"text\" name=\"select_choice_label_text[]\" class=\"form-control type_select_input select_choice_label_text\" value=\"<?php echo e(old('select_label_text"+select_choice_count+"')); ?>\">\n" +
    ...
    function add_radio_choice_wrap () {
      let html = "<div class=\"row form-inline mb-1\">\n" +
        "<input type=\"text\" name=\"radio_choice_label_text[]\" class=\"form-control type_select_input radio_choice_label_text\" value=\"<?php echo e(old('label_text"+radio_choice_count+"')); ?>\">\n" +
...
<?php /**PATH /home/xs958314/yugyosen.com/public_html/public/contact/em_laravel/resources/views/admin/include/form_block_js.blade.php ENDPATH**/ ?>