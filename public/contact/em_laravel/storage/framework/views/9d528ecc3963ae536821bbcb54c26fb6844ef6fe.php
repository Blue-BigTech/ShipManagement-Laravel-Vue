<?php if($errors->any()): ?>
  <ul class="list-group m-0">
    <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <li class="list-group-item list-group-item-danger form__reqdMark"><?php echo e($error); ?></li>
      ...
      <dl class="form__block">
        ...
        <dd class="form__inputArea">
          ...
          <?php switch($form_item->form_type):
            ...
            <?php break; ?>
            <?php case ("textarea"): ?>
            <textarea name="<?php echo e($form_item->name); ?>" <?php echo e($form_item->html_id ? 'id='.$form_item->html_id:''); ?> class="form__textArea <?php echo e($form_item->html_class); ?> js_input_control" placeholder="<?php echo e($form_item->placeholder); ?>"><?php if(old($form_item->name)): ?><?php echo e(old($form_item->name)); ?><?php else: ?><?php echo e($form_item->initial_value); ?><?php endif; ?></textarea>
            <?php break; ?>
            <?php case ("select"): ?>
              ...
              <select name="<?php echo e($form_item->name); ?>" <?php echo e($form_item->html_id ? 'id='.$form_item->html_id:''); ?> class="form__select <?php echo e($form_item->html_class); ?> js_input_control">
                ...
                <?php $__currentLoopData = $choices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $choice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($choice->choice_type == "select" && $form_item->form_block_id == $choice->block_id): ?>
                    <option value="<?php echo e($choice->label_text); ?>" <?php if(old($form_item->name) == $choice->label_text): ?> selected <?php endif; ?>><?php echo e($choice->label_text); ?></option>
                  <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
            ...
            <?php break; ?>
            <?php case ("file"): ?>
            <input type="file" name="<?php echo e($form_item->name); ?>" <?php echo e($form_item->html_id ? 'id='.$form_item->html_id.'"':''); ?> class="form__input <?php echo e($form_item->html_class); ?> js_input_control" value="<?php echo e($form_item->initial_value); ?>" placeholder="<?php echo e($form_item->placeholder); ?>" accept="<?php echo e($form_item->file_type); ?>"/>
            ...
            <?php break; ?>
            <?php case ("zp_address"): ?>
            <span class="js_input_control"><?php echo e(__("validation.attributes.zip")); ?></span>
...
<?php $__env->stopSection(); ?>
<?php /**PATH /home/xs958314/yugyosen.com/public_html/public/contact/em_laravel/resources/views/theme/one_column/form.blade.php ENDPATH**/ ?>